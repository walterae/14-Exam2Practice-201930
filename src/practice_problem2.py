...
def run_test_practice_problem2a():
    ...
    actual = practice_problem2a([3, 4, 5, 6, 7, 8, 9],2)
    print()
    ...
    # Test 2:
    expected = [4, 5, 5, 4, 8]
    actual = practice_problem2a([1, 2, 2, 1, 5],3)
    print()
    ...
    # Test 3:
    expected = [5, 4, -3, -4, 6]
    actual = practice_problem2a([0, -1, -8, -9, 1],5)
    print()
    ...
    # Test 4:
    expected = [2, 3, 1, 0, -3]
    actual = practice_problem2a([0, 1, -1 , -2 , -5],2)
    print()
